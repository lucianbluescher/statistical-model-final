...
We model proportional response PR with a beta regression using a logit link:
...
p_snow <- snow_grid |>
  ...
  labs(
    ...
    caption = "Snow slope is near zero; PR stays effectively flat across observed snow depths."
  ) +
